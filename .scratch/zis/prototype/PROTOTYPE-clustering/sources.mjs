...
export const PUBLISHERS = [
  ...
  { id: 'theregister', name: 'The Register', hosts: ['theregister.com'], sources: [
    { transport: 'rss', url: 'https://www.theregister.com/headlines.atom' },
  ]},
  { id: 'lwn', name: 'LWN', hosts: ['lwn.net'], sources: [
    { transport: 'rss', url: 'https://lwn.net/headlines/newrss' },
  ]},
  { id: 'infoq', name: 'InfoQ', hosts: ['infoq.com'], sources: [
    { transport: 'rss', url: 'https://feed.infoq.com/' },
  ]},
